...
namespace CustomerWebApi.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        {
            new Customer { CustomerId = 1, CustomerName = "Alice", MobileNumber = "123-456", Email = "alice@example.com" },
            new Customer { CustomerId = 2, CustomerName = "Bob", MobileNumber = "789-012", Email = "bob@example.com" }
        };
